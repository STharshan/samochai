  ...
  return (
    <section id="hero" className="relative text-white text-center px-4">
      ...
      <div className="relative z-10 py-32 md:py-48">
        <h1
          className="lg:text-7xl text-5xl font-extrabold text-gray-900 mb-8 shadow-lg"
          data-aos="fade-down"
          data-aos-delay="200"
        >
          Craving a taste of
        ...
        <h1
          className="text-4xl md:text-7xl font-bold mb-4 text-gray-900 shadow-lg"
          data-aos="fade-up"
          data-aos-delay="400"
        >
        ...
        <p
          className="text-lg md:text-2xl text-gray-200 max-w-3xl mx-auto mb-10 shadow-md"
          data-aos="fade-in"
          data-aos-delay="600"
        >
