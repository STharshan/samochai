  ...
  return (
    <footer className="bg-white text-black px-6 py-5">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 text-left mt-15">
        ...
        <div>
          ...
          <div className="flex space-x-4 text-white">
            <a href="#" className="hover:text-blue-600 text-black"><FaFacebookF /></a>
            <a href="https://www.instagram.com/samochaihouse/" className="hover:text-pink-500 text-black"><FaInstagram /></a>
            <a href="#" className="hover:text-blue-400 text-black"><FaTwitter /></a>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-md  font-semibold">
            ...
            <li className="flex items-center gap-4">
              <FiPhone className="text-green-800"/> +880 1234-567890
            </li>
            <li className="flex items-center gap-4">
              <FiMail className="text-green-800" /> hello@samochai.com
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="text-center text-md  font-semibold mt-2">
        Powered By <a href="https://www.ansely.co.uk/" className="hover:text-green-800 hover:underline">Ansely</a>
      </div>
    </footer>
  );
};
