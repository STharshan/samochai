...
const Mission = () => {
    ...
    return (
        <section className="w-full py-16 px-4 md:px-12 bg-[#f8f3ec]">
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-20 items-center">
                ...
                <div className="relative z-10">
                    <div className="bg-[#f1642b] rounded-2xl p-8 sm:p-8 text-white relative overflow-hidden min-h-[340px] pr-28 md:pr-32">
                        ...
                        <div className="space-y-3 mb-6">
                            <div className="flex items-center gap-2 bg-[#512c0d] px-4 py-2 rounded-full text-sm w-fit">
                                <FaCheck className="text-[#a972f7]" />
                        ...
                        <div className="flex gap-3 mb-4">
                            <div className="bg-white text-[#f1642b] p-2 rounded-full">
