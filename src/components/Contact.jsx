    ...
    <div id='contact' className="scroll-m-10 min-h-screen w-full bg-white text-white p-4 md:p-12 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 relative z-10">
        <div className={`bg-gradient-to-br from-[#12392c] to-[#0e2a20] rounded-xl p-6 md:p-8 shadow-2xl transition-all duration-1000 hover:shadow-green-900/50 ${animate ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            {["name", "email", "phone"].map((field) => (
              <div key={field}>
                <input
                  ...
                  className={`bg-[#0a1f17] border ${errors[field] ? 'border-red-500' : 'border-green-700/50'} placeholder-gray-400 rounded-lg p-3 w-full focus:ring-2 focus:ring-green-500 transition-all text-white outline-none`}
                />
          ...
          <div className="mb-6">
            ...
            <div className="space-y-4 max-h-96 overflow-y-auto pr-2 
              ...
              [&::-webkit-scrollbar-track]:bg-[#0a1f17] 
              [&::-webkit-scrollbar-track]:rounded-full
              [&::-webkit-scrollbar-thumb]:bg-[#346909] 
              [&::-webkit-scrollbar-thumb]:rounded-full
              hover:[&::-webkit-scrollbar-thumb]:bg-[#4a8c0f]">
              
              {menuItems.map((m, index) => (
                <div key={m.id} className="bg-[#0a1f17] rounded-lg p-4 border border-green-700/30 hover:border-green-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-green-900/30">
                  ...
                  <div className="space-y-3">
                    <select
                      ...
                      className="bg-[#12392c] border border-green-700/50 text-white rounded-lg p-2.5 w-full outline-none"
                    >
                    ...
                    <select
                      ...
                      className="bg-[#12392c] border border-green-700/50 text-white rounded-lg p-2.5 w-full disabled:opacity-50 outline-none"
                    >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <input
                        ...
                        className="bg-[#12392c] border border-green-700/50 text-white rounded-lg p-2 w-20 text-center outline-none"
                      />
                    </div>
                  </div>
                </div>
            ...
            <button onClick={addMenuItem} className="w-full mt-4 bg-gradient-to-r from-green-700 to-green-600 text-white font-semibold py-3 rounded-lg flex items-center justify-center gap-2 hover:scale-[1.02] transition-all">
          ...
          <textarea
            ...
            value={form.message}
            onChange={handleChange}
            className="bg-[#0a1f17] border border-green-700/50 text-white rounded-lg p-3 w-full resize-none outline-none mb-6"
          />
        ...
        <div className={`flex flex-col gap-6 transition-all duration-1000 delay-300 ${animate ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
          <div className="bg-gradient-to-br from-[#12392c] to-[#0e2a20] rounded-xl p-5 flex gap-4 items-center shadow-xl">
          ...
          <div className="bg-gradient-to-br from-[#12392c] to-[#0e2a20] rounded-xl p-5 flex gap-4 items-start shadow-xl">
